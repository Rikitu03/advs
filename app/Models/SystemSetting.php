    ...
    public static function schema(): array
    {
        return [
            ...
            'Model Confidence Thresholds' => [
                ...
                ['key' => 'signature_enroll_detection_confidence', 'label' => 'Signature enrollment YOLOv8 confidence (0–1)', 'type' => 'float', 'min' => 0, 'max' => 1, 'step' => 0.01, 'default' => 0.20, 'hint' => 'Minimum detection confidence for the dedicated registration signature detector.'],
