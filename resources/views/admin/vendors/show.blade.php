<x-layouts.app>
    @php
        $v = $vendor;
        $statusColor = \App\Support\DemoData::vendorStatusColor($v['status']);
        $riskLevel = \App\Support\DemoData::riskLevel((int) $v['risk_score']);
    @endphp
    ...
    <div class="-m-6 min-h-full bg-cu-bg p-6 text-cu-text lg:-m-8 lg:p-8">
        <div class="mx-auto flex w-full max-w-7xl flex-col gap-6">
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                {{-- Company details --}}
                <div class="rounded-2xl border border-white/5 bg-cu-surface p-5 lg:col-span-2">
                ...
                <div class="flex flex-col gap-4 rounded-2xl border border-white/5 bg-cu-surface p-5">
