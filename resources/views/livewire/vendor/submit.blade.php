        ...
        <div class="grid gap-6 lg:grid-cols-[1fr_360px]">
            <div class="cu-animate-in rounded-2xl border border-cu-border bg-cu-surface shadow-sm">
                ...
                <div class="flex flex-col gap-5 p-5">
                    ...
                    >
                        <button type="button" @click="$refs.upload.click()" :disabled="submitting" class="mx-auto flex size-12 items-center justify-center rounded-xl bg-cu-blue/10 text-cu-blue ring-1 ring-cu-blue/20 transition hover:bg-cu-blue/20 disabled:cursor-not-allowed disabled:opacity-60">
                        <button type="button" @click="$refs.upload.click()" :disabled="submitting" class="mx-auto flex size-12 items-center justify-center rounded-xl bg-cu-blue/10 text-cu-blue ring-1 ring-cu-blue/20 transition hover:bg-cu-blue/20 disabled:cursor-not-allowed disabled:opacity-60">
