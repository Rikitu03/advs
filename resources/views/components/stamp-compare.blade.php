...
@unless ($detected)
    <div class="flex items-center gap-3 rounded-xl border border-amber-400/20 bg-amber-400/5 px-4 py-3">
        ...
        <p class="text-sm text-cu-text">No stamp region was detected by YOLOv8, so no comparison could be run. A missing-component penalty was applied to the risk score.</p>
    </div>
@else
