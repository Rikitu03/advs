...
@php
    $classes = match ($status) {
        'Processing' => 'border-cu-blue/30 bg-cu-blue/10 text-cu-blue',
        'Pending Review' => 'border-cu-yellow/60 bg-cu-yellow/20 text-cu-yellow',
        'Approved' => 'border-emerald-500/40 bg-emerald-500/15 text-emerald-700 dark:text-emerald-300',
        'Rejected', 'Resubmission Requested' => 'border-rose-500/40 bg-rose-500/15 text-rose-700 dark:text-rose-300',
